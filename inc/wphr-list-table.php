 ...
 * 
 */
class wphrListTable extends WP_List_Table {
    /*******
   ...
   function data(){
        global $wpdb;
        $results = $wpdb->get_results('SELECT * FROM '.WPHR_TABLE, ARRAY_A);
        return $results;  
    }
    ...
    function column_default($item, $column_name){
        switch($column_name){
            ...
            case 'special_requirements':
                return $item[$column_name];
            case 'status':
                return $this->reservationStatus($item['id']);
            default:
    ...
    *******/
    ...
    function process_bulk_action() {
        ...
        else if('deletebulk' === $this->current_action()){
        ...
        else if( 'confirm'===$this->current_action() ) {

            $id = $_REQUEST['reservation'];
            $status = $this->confirmItem($id);
            if($status){
...
function wphrRenderListTable(){
    
    //Create an instance of our package class...
    $listTable = new wphrListTable();
